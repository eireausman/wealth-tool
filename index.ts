...
app.use(express.static(path.join(__dirname, "../wealth-tool-client/build")));
// view engine setup
...
app.use("/", (req: Request, res: Response, next: NextFunction) => {
  ...
  //   __dirname,
  //   "../wealth-tool-client/build/index.html"
  // );

  // res.sendFile("index.html");
  res.sendFile(
    path.join(__dirname, "../wealth-tool-client/build", "index.html")
  );
});
...
app.listen(port, () => {
  console.log(`⚡️[server]: Server is running at ${__dirname} ${port}`);
});
